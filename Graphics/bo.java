...
public final class bo extends GraphicParent {
  ...
  public final void a(Graphics paramGraphics, int paramInt1, int paramInt2) {
    ...
    paramInt2 = r.j - 60;
    ao ao = n.a();
    c(paramGraphics, paramInt1, paramInt2, 135, 120);
    b(paramGraphics, paramInt1 + 3, paramInt2 + 3, 129, 17, 10452863);
    paramGraphics.setColor(16777215);
    bh.a(paramGraphics, paramInt1 + 6, paramInt2 + 4, this.a, 1);
    b(paramGraphics, paramInt1 + 3, paramInt2 + 25, 129, 60, 10452863);
    paramGraphics.setColor(16777215);
    ...
    b(paramGraphics, paramInt1 + 3, paramInt2 + 98, 129, 15, 10452863);
    paramGraphics.setColor(16777215);
